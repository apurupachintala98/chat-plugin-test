...
//   // Extract keys for x-axis and y-axis options
//   const dataKeys = chartData && chartData.length > 0 ? Object.keys(chartData[0]) : [];

//   // Limit data to top 10-20 items
...
//       case 'pie':
//         return {
//           chart: { type: 'variablepie' }, // Variable radius pie chart
...
//       case 'bubble':
//         return {
//           chart: { type: 'bubble', plotBorderWidth: 1, zoomType: 'xy' }, // Bubble chart
//           title: { text: titleText },
//           xAxis: {
//             title: { text: xAxisKey },
//           },
...
//       case 'bar':
//         return {
//           chart: { type: 'bar' }, // Basic bar chart
//           title: { text: titleText },
//           xAxis: { categories: limitedData.map(item => item[xAxisKey]) },
//           series: [{
//             name: yAxisKey,
...
//       case 'column':
//         return {
//           chart: { type: 'column' }, // Basic column chart
//           title: { text: titleText },
//           xAxis: { categories: limitedData.map(item => item[xAxisKey]) },
//           series: [{
//             name: yAxisKey,
...
//       default:
//         return {
//           chart: { type: 'line' }, // Default to line chart
//           title: { text: titleText },
//           xAxis: { categories: limitedData.map(item => item[xAxisKey]) },
//           series: [{
//             name: yAxisKey,
